        ...
        $application
            ...
            ->setCode(
                function (InputInterface $input, OutputInterface $output) {
                    ...
                    self::replaceInFile(sprintf('%s/tools/docker/web/docker-compose-init.sh', __DIR__), 'skeleton.lcl', $settings['hostname']);
                    self::replaceInFile(sprintf('%s/tools/docker/web/docker-compose-init.sh', __DIR__), '192.168.33.2', $settings['ipAddress']);
